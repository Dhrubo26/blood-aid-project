...
def accept_request_api(id):
    ...
    try:
        ...
        return jsonify({'success': True, 'message': 'Request accepted successfully', 'tracking_url': tracking_url})
    except Exception as e:
        db.session.rollback()
...
def admin_panel():
    ...
    return render_template('admin_view.html', donors=all_donors, requests=all_requests, messages=messages, subscriptions=subscriptions)
